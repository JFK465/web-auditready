        ...
        <div className="container-custom max-w-3xl">
          ...
          <div className="mt-10 bg-primary/5 border border-primary/20 rounded-xl p-6">
            <h3 className="font-semibold mb-2">
              AuditReady — WPK-Software für EN 1090
            </h3>
            <p className="text-muted-foreground text-sm mb-4">
              Digitalisieren Sie Ihr WPK-System, erhalten Sie einen
              automatischen Compliance-Score und generieren Sie das Audit-Paket
              auf Knopfdruck.
            </p>
            <Button asChild>

...
const PROJECT_ID = "auditready";
const PROJECT_DOMAIN = "werkseigene-produktionskontrolle.de";
const PROJECT_DISPLAY_NAME = "AuditReady";
const PROJECT_PRIMARY_COLOR = "#2563EB";
const PROJECT_ACCENT_COLOR = "#1E40AF";
const PROJECT_ADMIN_EMAIL = "info@werkseigene-produktionskontrolle.de";
const PROJECT_TAGLINE = "Digitales WPK-Cockpit mit automatischer Gap-Analyse, Compliance-Score und Ein-Klick Audit-Paket-Generator";
